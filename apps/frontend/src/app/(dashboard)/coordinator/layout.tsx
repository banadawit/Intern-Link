    ...
    <CoordinatorRouteGuard>
      ...
      <div className="flex min-h-screen flex-col bg-slate-50 text-slate-600 antialiased lg:flex-row dark:bg-slate-950 dark:text-slate-300">
        ...
        <div className="flex min-h-0 min-w-0 flex-1 flex-col">
          <div className="sticky top-0 z-50 flex shrink-0 items-center justify-end gap-2 border-b border-border-default bg-bg-main px-4 py-3 sm:px-6 lg:px-8 dark:border-slate-700 dark:bg-slate-900">
            <LanguageSwitcher />
