...
// ── Coordinator / Supervisor person types ──────────────────────────────────
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left text-sm">
              ...
              <tbody className="divide-y divide-slate-100">
                {rows.map((c) => (
                  <tr key={`${c._status}-${c.id}`} className="hover:bg-slate-50/60 transition-colors">
        ...
        {loading ? (
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left text-sm">
              ...
              <tbody className="divide-y divide-slate-100">
                {rows.map((s) => (
                  <tr key={`${s._status}-${s.id}`} className="hover:bg-slate-50/60 transition-colors">
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                    ...
                    <td className="px-6 py-4 text-sm text-slate-600">{s.company.name}</td>
