...
import { MOCK_STUDENT, MOCK_WEEKLY_PLANS } from '../../mockData';
import { cn } from '../../lib/utils';
import { Link } from 'react-router-dom';

const StudentDashboard = () => {
  const latestPlans = MOCK_WEEKLY_PLANS.slice(-3).reverse();
    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="card p-6">
          ...
          <div className="space-y-3">
            <Link to="/student/plans" className="flex items-center justify-between p-4 rounded-xl bg-bg-secondary hover:bg-bg-tertiary transition-all group">
            ...
            <Link to="/student/common" className="flex items-center justify-between p-4 rounded-xl bg-bg-secondary hover:bg-bg-tertiary transition-all group">
      ...
      <div className="card p-6">
        <div className="flex items-center justify-between mb-6">
          ...
          <Link to="/student/plans" className="text-sm font-medium text-primary-base hover:underline">View all weeks</Link>
        </div>
          ...
          {latestPlans.map((plan) => (
            <div key={plan.id} className="flex items-center justify-between p-4 rounded-xl border border-border-default hover:border-primary-base/30 transition-all">
              ...
              <div className="flex items-center gap-6">
                ...
                <Link to="/student/plans" className="p-2 hover:bg-bg-tertiary rounded-lg transition-colors">
