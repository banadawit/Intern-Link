                    ...
                    delegate: SliverChildListDelegate(
                      evaluation == null
                          ...
                          : [
                              ...
                              const SizedBox(height: 16),
                              _buildSkillProgress(context, 'Technical Skills',
                                  (evaluation.technicalSkills / 100).clamp(0.0, 1.0), Colors.blue),
                              _buildSkillProgress(context, 'Problem Solving',
                                  (evaluation.problemSolving / 100).clamp(0.0, 1.0), Colors.indigo),
                              _buildSkillProgress(context, 'Communication',
                                  (evaluation.communication / 100).clamp(0.0, 1.0), Colors.teal),
                              _buildSkillProgress(context, 'Team Collaboration',
                                  (evaluation.teamCollaboration / 100).clamp(0.0, 1.0), Colors.green),
                              _buildSkillProgress(context, 'Time Management',
                                  (evaluation.timeManagement / 100).clamp(0.0, 1.0), Colors.orange),
                              _buildSkillProgress(context, 'Adaptability',
                                  (evaluation.adaptability / 100).clamp(0.0, 1.0), Colors.amber),
                              _buildSkillProgress(context, 'Professionalism',
                                  (evaluation.professionalism / 100).clamp(0.0, 1.0), Colors.purple),
                              _buildSkillProgress(context, 'Initiative & Creativity',
                                  (evaluation.initiativeCreativity / 100).clamp(0.0, 1.0), Colors.pink),
                              _buildSkillProgress(context, 'Attendance & Punctuality',
                                  (evaluation.attendancePunctuality / 100).clamp(0.0, 1.0), Colors.cyan),
                              _buildSkillProgress(context, 'Task Completion Quality',
                                  (evaluation.taskCompletionQuality / 100).clamp(0.0, 1.0), Colors.deepOrange),
                              const SizedBox(height: 32),
